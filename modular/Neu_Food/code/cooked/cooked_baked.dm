...
/obj/item/reagent_containers/food/snacks/rogue/bun_marmalade
	name = "marmaladed bun"
	desc = "A delicious treat to bring along for those long-and-lonesome hikes through the Sunmarch forests; doubly-so, if you happen to be a tallow-coated wildkin of the urisine variety."
	icon = 'modular/Neu_Food/icons/cooked/cooked_baked.dmi'
...
/obj/item/reagent_containers/food/snacks/rogue/tomatoplate
	name = "tomatoplate"
	desc = "A culinary delight from Sunmarch's shores, purported to've originated from an inflow of Etruscean refugees from long ago. The \
...
/obj/item/reagent_containers/food/snacks/rogue/peartomatoplate
	...
	desc = "A curious spin on a Sunmarcher classic, attributed to the hands of Vanderlin's most esteemed culinarians. The \
