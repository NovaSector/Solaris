/obj/structure/roguemachine/vaultbank
	...
	desc = "A biomechanical obselisk that collects and secures the treasury of the Grand Duchy of Sunmarch. Throttle it with a strike to spill that which is rightfully yours."
