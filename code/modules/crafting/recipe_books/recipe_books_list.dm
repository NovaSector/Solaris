...
/obj/item/recipe_book/survival
	name = "Tips, Tricks, & Triumphs: The Novice's Handbook To Sunmarch"
	wiki_name = "Survival"
	desc = "A heftsome tome, filled to the brim with all the information you'd need to survive within Sunmarch. The golden bookmark seems to always lead you \
	to the page you needed the most, no matter how you flip it. </br>‎  </br>Check out Solaris Ridge's official wikipedia - https://solaris.novasector13.com - for \
...
/obj/item/recipe_book/survival/get_mechanics_examine(mob/user)
	...
	. += span_info("Likewise, try checking out Solaris Ridge's official wikipedia - https://solaris.novasector13.com - for anything else you might wish to learn about.")
