...
/obj/item/reagent_containers/food/snacks/grown/pepperseed
	name = "pepperberries"
	desc = "A relative to the Sunmarch jackberry, stripped free of its fruity skin. Roasting it seems to've dulled its humor-imbalancing \
...
/obj/item/reagent_containers/food/snacks/grown/fruit/blackberry/skysugarbase
	...
	alchemically pure substance. South of Solaris Ridge's border, it's known as 'skysugar'; a Pestran heresy, rumored to've originally been \
...
/obj/item/reagent_containers/food/snacks/grown/skysugarslab
	...
	it 'luchtblauw' in Old Sunmarcher; alchemically purified starsugar, to a ninth-of-a-hundreth dram. Born of a Pestran heresy, this \
