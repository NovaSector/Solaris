...
/obj/structure/globe
	...
	and on the northern half of the western continent, a modest peninsula marked as 'Solaris Ridge'."
	icon = 'icons/roguetown/misc/structure.dmi'
	icon_state = "globe"
	density = TRUE
	anchored = FALSE
