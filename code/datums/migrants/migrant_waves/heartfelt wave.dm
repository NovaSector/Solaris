/datum/migrant_wave/heartfelt
	...
	greet_text = "Fleeing the disaster at Heartfelt, you have come together - to find aide for your house, or to infest Sunmarch with the boons of the Ecclesiarchs.. Stay close and watch out for each other, for all of your sakes!"
...
/datum/migrant_wave/heartfelt_down_one
	...
	greet_text = "Fleeing the disaster at Heartfelt, you have come together - to find aide for your house, or to infest Sunmarch with the boons of the Ecclesiarchs.. Stay close and watch out for each other, for all of your sakes! Some of you already did not make it on the way here..."
...
/datum/migrant_wave/heartfelt_down_seven
	...
	greet_text = "Fleeing the disaster at Heartfelt, you have come together - to find aide for your house, or to infest Sunmarch with the boons of the Ecclesiarchs. Now, in the end, it is only the Lord and their trusty knight left on their lonesome..."
...
/datum/migrant_wave/heartfelt_down_eight
	...
	greet_text = "Fleeing the disaster at Heartfelt, you have come together - to find aide for your house, or to infest Sunmarch with the boons of the Ecclesiarchs. Now, in the end, it is only the Lord and their trusty Hand left on their lonesome..."
