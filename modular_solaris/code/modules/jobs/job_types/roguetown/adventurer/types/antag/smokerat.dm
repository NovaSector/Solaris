/datum/advclass/smokerat //Handgonner go boom
	...
	cmode_music = 'modular_solaris/sound/music/combat_bandit2.ogg'
...
/datum/outfit/job/roguetown/bandit/smokerat/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/rogueweapon/huntingknife/idagger/steel = 1, /obj/item/flashlight/flare/torch/lantern = 1, /obj/item/storage/belt/rogue/pouch/coins/poor = 1)
